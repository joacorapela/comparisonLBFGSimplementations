...
def main(argv):
    ...
    parser.add_argument("--resultsFilenamePattern", help="results filename pattern", default="../results/scipy_pyTorchAutograd_{:s}.csv")
    ...
    if generativeFunc=="rosenbrock":
        evalFunc = testFunctions.rosenbrockWithAutograd
    elif generativeFunc=="sixHumpCamel":
        evalFunc = testFunctions.sixHumpCamelWithAutograd
    elif generativeFunc=="zakharov":
        evalFunc = testFunctions.zakharovWithAutograd
    else:
